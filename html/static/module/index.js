        ...
        if ((nowTime - lastMenuClickTime) >= 500) {
            ...
            $.app.getJson(contextpath + '/passport/heartbeat', null, function(data, status, xhr){
            	...
            	if(status==1){
            		...
            		// setNavpath
            		//var navpath = [];
            		//var systemnametitle = $('.systemName.selected span:last').text();
            		//navpath.push(systemnametitle);
            		//var accordtitle = $("#RightAccordion").accordion('getSelected').panel('options').title;
            		//navpath.push(accordtitle);
